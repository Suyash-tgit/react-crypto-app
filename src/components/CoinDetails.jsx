        ...
        <>
          ...
          <VStack spacing={"4"} p={"16"} alignItems={"flex-start"}>
            ...
            <Stat>
              ...
              <StatHelpText>
                <StatArrow
                  type={parseFloat(coin.market_data.price_change_percentage_24h) >= 0 ? "increase" : "decrease"}
                >
            ...
            <Box w={"full"} p={4}>
              ...
              <Item title={"Marketing Capital"} value={`${currencySymbol}${coin.market_data.market_cap[currency]}`} />
